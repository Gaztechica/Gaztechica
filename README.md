...
- 💪 I like to write code QA automation using Java
- 🥅 I am constantly learning new things
##  Что умею:

- Создание UI автотестов на Java + Selenium часть проекта на Selenide;
- Создание API автотестов на Java + Rest Assured
- Создание и запуск Job в Jenkins для прогона
- Развертка и настройка тестовой инфраструктуры
- Анализ прогона в Allure
- Выявления багов по результату прогона и составление баг репортов в ТестОпс
- Составление отчётов тестирования
- Оптимизация и рефакторинг кода
- Проведение функционального, регрессионного и интеграционного тестирования для web приложений
- Проведения Code Review
- Нагрузочное тестирование Gatling
- Поддержка проекта тестирования
- Составление и актуализация тестовой документации
- Составление документации по проекту
- Обновление тестовых стендов
- Локализация проблем
- Использование xpath/css селекторов
- Использование CI\CD
- тесно взаимодействую со всей командой проекта
  
<!-- ## Портфолио 🧰
  -  [My portfolio](https://github.com/Gaztechica/test_)
-->
## Мои контакты
